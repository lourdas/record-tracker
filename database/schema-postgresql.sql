...
CREATE INDEX "log_record_tablename_idx" ON "log_record"
USING btree ("table_name" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST, "rec_id");
...
ALTER TABLE "log_record_detail"
    ADD CONSTRAINT "log_record_detail_log_record_fk" FOREIGN KEY ("id_log_record") REFERENCES "log_record" ("id") ON DELETE CASCADE ON
    UPDATE
